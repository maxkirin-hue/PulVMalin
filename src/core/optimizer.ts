/* =========================================================
   ...
   - Rampe : coefs = pondérations DU TOTAL
========================================================= */
...
/* Rampe : coefs = pondérations DU TOTAL */
function computeTargetsNormalized(
  qTotal: number,
  coefs: number[]
): number[] {
...
export function computeAll(): void {
  ...
  const opt = optimizePressureAndNozzles(fam, targets, state.familyKey);
