...
export interface NozzleFamily {
  label: string;
  machines?: ("viti" | "arbo" | "rampe" | "tangentiel")[];
  refPressure: number;
...
export const nozzleFamilies: Record<string, NozzleFamily> = {
  ...
  TXR: {
    ...
    nozzles: [
      ...
      { code: "TXR80049", color: "blanc", qRef: 3.5 }
    ]
  },

  IDK90: {
    label: "IDK 90 – Injection d'air",
    machines: ["arbo", "tangentiel"],
    refPressure: 10,
    optimalRange: [5, 14],
    limitRange: [4, 20],
    nozzles: [
  ...
  AD90: {
    ...
    nozzles: [
      ...
      { code: "AD 90-02", color: "rouge", qRef: 0.8 },
